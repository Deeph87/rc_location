...
--
-- Client :  127.0.0.1
-- Généré le :  Dim 28 Mai 2017 à 16:09
...
INSERT INTO `users` (`id`, `username`, `firstname`, `lastname`, `mail`, `city`, `zip_code`, `address`, `address_add`, `phone`, `password`, `role`) VALUES
(1, 'Romain', 'Romain', 'Simon', 's-rom1@live.fr', 'Troyes', 10000, '115 rue ssss', '', '', '$2y$10$vdD43ZdEjRIMtpo2rUXEuOjxZ7WOX9BnmtTQRBD8yacehJCXDkB92', 1);
